          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                MediaView(post: widget.postView.post, postView: widget.postView),
                ...
                Row(
                  ...
                  children: [
                    IconButton(
                      onPressed: isUserLoggedIn ? () => context.read<PostBloc>().add(VotePostEvent(postId: widget.postView.post.id, score: widget.postView.myVote == 1 ? 0 : 1)) : null,
                    ...
                    IconButton(
                      onPressed: isUserLoggedIn ? () => context.read<PostBloc>().add(SavePostEvent(postId: widget.postView.post.id, save: !widget.postView.saved)) : null,
