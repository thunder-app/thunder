...
class _CommentCardState extends State<CommentCard>
  ...
  Widget build(BuildContext context) {
    ...
    bool? isCommentNew = widget.now
            .difference(widget.commentViewTree.commentView!.comment.published)
            .inMinutes <
        15;
    ...
    final bool isOwnComment = widget.commentViewTree.commentView?.creator.id ==
    ...
    return Container(
      ...
      decoration:
          nestedCommentIndicatorStyle == NestedCommentIndicatorStyle.thick
              ? BoxDecoration(color: theme.dividerColor.withOpacity(.3))
              : const BoxDecoration(),
      child: Container(
        decoration: BoxDecoration(
          color: widget.selectCommentId ==
                  widget.commentViewTree.commentView!.comment.id
              ? theme.highlightColor
              : theme.colorScheme.background,
          border:
              nestedCommentIndicatorStyle == NestedCommentIndicatorStyle.thin
                  ? Border(
                      left: BorderSide(
          ...
          children: [
            ...
            Container(
              ...
              child: Listener(
                  ...
                  if (swipeAction != null && swipeAction != SwipeAction.none)
                    {
                      triggerCommentAction(
                        ...
                        onSaveAction: (int commentId, bool saved) =>
                            widget.onSaveAction(commentId, saved),
                        onVoteAction: (int commentId, VoteType vote) =>
                ...
                child: Dismissible(
                  direction: state.enableCommentGestures == false
                      ? DismissDirection.none
                      : determineCommentSwipeDirection(isUserLoggedIn, state),
                  key:
                      ObjectKey(widget.commentViewTree.commentView!.comment.id),
                  ...
                  child: Column(
                    ...
                    children: [
                      GestureDetector(
                        ...
                        onLongPress: () => showCommentActionBottomModalSheet(
                            context,
                            widget.commentViewTree,
                            widget.onSaveAction,
                            widget.onDeleteAction),
                        onTap: () {
                          widget.onCollapseCommentChange(
                              widget.commentViewTree.commentView!.comment.id,
                              !isHidden);
                                      ...
                                      children: [
                                        Padding(
                                          padding: EdgeInsets.only(
                                              ...
                                              left: 8.0,
                                              bottom:
                                                  (state.showCommentButtonActions &&
                                                          isUserLoggedIn)
                                                      ? 0.0
                                                      : 8.0),
            ...
            AnimatedSwitcher(
              ...
              child: isHidden
                  ? Container()
                  : widget.commentViewTree.replies.isEmpty &&
                          widget.commentViewTree.commentView!.counts
                                  .childCount >
                              0
                      ? GestureDetector(
                          behavior: HitTestBehavior.opaque,
                          onTap: () {
                            context.read<PostBloc>().add(GetPostCommentsEvent(
                                commentParentId: widget
                                    .commentViewTree.commentView!.comment.id));
                            setState(() {
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) => CommentCard(
                            ...
                            now: widget.now,
                            commentViewTree:
                                widget.commentViewTree.replies[index],
                            collapsedCommentSet: widget.collapsedCommentSet,
                            collapsed: widget.collapsedCommentSet.contains(
                                widget.commentViewTree.replies[index]
                          ...
                          itemCount: isHidden
                              ? 0
                              : widget.commentViewTree.replies.length,
                        ),
            ),
          ],
        ),
