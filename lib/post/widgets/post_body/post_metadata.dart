          ...
          children: postCardMetadataItems.map(
            (PostCardMetadataItem postCardMetadataItem) {
              return switch (postCardMetadataItem) {
                PostCardMetadataItem.commentCount => CommentCountPostCardMetaData(commentCount: commentCount, unreadCommentCount: unreadCommentCount ?? 0, dim: false),
                PostCardMetadataItem.dateTime => DateTimePostCardMetaData(dateTime: dateTime!, dim: false, edited: hasBeenEdited ?? false),
                PostCardMetadataItem.url => UrlPostCardMetaData(url: url, dim: false),
                _ => Container(),
              };
            },
          ).toList(),
