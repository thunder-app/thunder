        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: SmoothHighlight(
              key: settingToHighlight == LocalSettings.defaultFeedListingType ? settingToHighlightKey : null,
              useInitialHighLight: settingToHighlight == LocalSettings.defaultFeedListingType,
              enabled: settingToHighlight == LocalSettings.defaultFeedListingType,
          ...
          SliverToBoxAdapter(
            child: SmoothHighlight(
              key: settingToHighlight == LocalSettings.defaultFeedSortType ? settingToHighlightKey : null,
              useInitialHighLight: settingToHighlight == LocalSettings.defaultFeedSortType,
              enabled: settingToHighlight == LocalSettings.defaultFeedSortType,
              color: theme.colorScheme.primaryContainer,
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16.0),
                child: ListOption(
          ...
          SliverToBoxAdapter(
            child: SmoothHighlight(
              key: settingToHighlight == LocalSettings.defaultCommentSortType ? settingToHighlightKey : null,
              useInitialHighLight: settingToHighlight == LocalSettings.defaultCommentSortType,
              enabled: settingToHighlight == LocalSettings.defaultCommentSortType,
              color: theme.colorScheme.primaryContainer,
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16.0),
                child: ListOption(
          ...
          SliverToBoxAdapter(
            child: SmoothHighlight(
              key: settingToHighlight == LocalSettings.appLanguageCode ? settingToHighlightKey : null,
              useInitialHighLight: settingToHighlight == LocalSettings.appLanguageCode,
              enabled: settingToHighlight == LocalSettings.appLanguageCode,
              color: theme.colorScheme.primaryContainer,
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16.0),
                child: ListOption(
          ...
          SliverToBoxAdapter(
            child: SmoothHighlight(
              key: settingToHighlight == LocalSettings.hideNsfwPosts ? settingToHighlightKey : null,
              useInitialHighLight: settingToHighlight == LocalSettings.hideNsfwPosts,
              enabled: settingToHighlight == LocalSettings.hideNsfwPosts,
              color: theme.colorScheme.primaryContainer,
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16.0),
                child: ToggleOption(
          ...
          SliverToBoxAdapter(
            child: SmoothHighlight(
              key: settingToHighlight == LocalSettings.tappableAuthorCommunity ? settingToHighlightKey : null,
              useInitialHighLight: settingToHighlight == LocalSettings.tappableAuthorCommunity,
              enabled: settingToHighlight == LocalSettings.tappableAuthorCommunity,
              color: theme.colorScheme.primaryContainer,
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16.0),
                child: ToggleOption(
          ...
          SliverToBoxAdapter(
            child: SmoothHighlight(
              key: settingToHighlight == LocalSettings.markPostAsReadOnMediaView ? settingToHighlightKey : null,
              useInitialHighLight: settingToHighlight == LocalSettings.markPostAsReadOnMediaView,
              enabled: settingToHighlight == LocalSettings.markPostAsReadOnMediaView,
              color: theme.colorScheme.primaryContainer,
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16.0),
                child: ToggleOption(
          ...
          SliverToBoxAdapter(
            child: SmoothHighlight(
              key: settingToHighlight == LocalSettings.useTabletMode ? settingToHighlightKey : null,
              useInitialHighLight: settingToHighlight == LocalSettings.useTabletMode,
              enabled: settingToHighlight == LocalSettings.useTabletMode,
              color: theme.colorScheme.primaryContainer,
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16.0),
                child: ToggleOption(
          ...
          SliverToBoxAdapter(
            child: SmoothHighlight(
              key: settingToHighlight == LocalSettings.hideTopBarOnScroll ? settingToHighlightKey : null,
              useInitialHighLight: settingToHighlight == LocalSettings.hideTopBarOnScroll,
              enabled: settingToHighlight == LocalSettings.hideTopBarOnScroll,
              color: theme.colorScheme.primaryContainer,
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16.0),
                child: ToggleOption(
          ...
          SliverToBoxAdapter(
            child: SmoothHighlight(
              key: settingToHighlight == LocalSettings.useAdvancedShareSheet ? settingToHighlightKey : null,
              useInitialHighLight: settingToHighlight == LocalSettings.useAdvancedShareSheet,
              enabled: settingToHighlight == LocalSettings.useAdvancedShareSheet,
              color: theme.colorScheme.primaryContainer,
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16.0),
                child: ToggleOption(
          ...
          SliverToBoxAdapter(
            child: SmoothHighlight(
              key: settingToHighlight == LocalSettings.collapseParentCommentBodyOnGesture ? settingToHighlightKey : null,
              useInitialHighLight: settingToHighlight == LocalSettings.collapseParentCommentBodyOnGesture,
              enabled: settingToHighlight == LocalSettings.collapseParentCommentBodyOnGesture,
              color: theme.colorScheme.primaryContainer,
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16.0),
                child: ToggleOption(
          ...
          SliverToBoxAdapter(
            child: SmoothHighlight(
              key: settingToHighlight == LocalSettings.enableCommentNavigation ? settingToHighlightKey : null,
              useInitialHighLight: settingToHighlight == LocalSettings.enableCommentNavigation,
              enabled: settingToHighlight == LocalSettings.enableCommentNavigation,
              color: theme.colorScheme.primaryContainer,
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16.0),
                child: ToggleOption(
          ...
          SliverToBoxAdapter(
            child: SmoothHighlight(
              key: settingToHighlight == LocalSettings.combineNavAndFab ? settingToHighlightKey : null,
              useInitialHighLight: settingToHighlight == LocalSettings.combineNavAndFab,
              enabled: settingToHighlight == LocalSettings.combineNavAndFab,
              color: theme.colorScheme.primaryContainer,
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16.0),
                child: ToggleOption(
          ...
          if (!kIsWeb && Platform.isIOS)
            SliverToBoxAdapter(
              child: SmoothHighlight(
                key: settingToHighlight == LocalSettings.openLinksInReaderMode ? settingToHighlightKey : null,
                useInitialHighLight: settingToHighlight == LocalSettings.openLinksInReaderMode,
                enabled: settingToHighlight == LocalSettings.openLinksInReaderMode,
                color: theme.colorScheme.primaryContainer,
                child: Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 16.0),
                  child: ToggleOption(
          ...
          if (!kIsWeb && Platform.isAndroid)
            SliverToBoxAdapter(
              child: SmoothHighlight(
                key: settingToHighlight == LocalSettings.openByDefault ? settingToHighlightKey : null,
                useInitialHighLight: settingToHighlight == LocalSettings.openByDefault,
                enabled: settingToHighlight == LocalSettings.openByDefault,
                color: theme.colorScheme.primaryContainer,
                child: Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 16.0),
          ...
          SliverToBoxAdapter(
            child: SmoothHighlight(
              key: settingToHighlight == LocalSettings.scrapeMissingPreviews ? settingToHighlightKey : null,
              useInitialHighLight: settingToHighlight == LocalSettings.scrapeMissingPreviews,
              enabled: settingToHighlight == LocalSettings.scrapeMissingPreviews,
              color: theme.colorScheme.primaryContainer,
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16.0),
                child: ToggleOption(
          ...
          SliverToBoxAdapter(
            child: SmoothHighlight(
              key: settingToHighlight == LocalSettings.userFormat ? settingToHighlightKey : null,
              useInitialHighLight: settingToHighlight == LocalSettings.userFormat,
              enabled: settingToHighlight == LocalSettings.userFormat,
              color: theme.colorScheme.primaryContainer,
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16.0),
                child: ListOption(
          ...
          SliverToBoxAdapter(
            child: SmoothHighlight(
              key: settingToHighlight == LocalSettings.communityFormat ? settingToHighlightKey : null,
              useInitialHighLight: settingToHighlight == LocalSettings.communityFormat,
              enabled: settingToHighlight == LocalSettings.communityFormat,
              color: theme.colorScheme.primaryContainer,
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16.0),
                child: ListOption(
          ...
          SliverToBoxAdapter(
            child: SmoothHighlight(
              key: settingToHighlight == LocalSettings.showInAppUpdateNotification ? settingToHighlightKey : null,
              useInitialHighLight: settingToHighlight == LocalSettings.showInAppUpdateNotification,
              enabled: settingToHighlight == LocalSettings.showInAppUpdateNotification,
              color: theme.colorScheme.primaryContainer,
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16.0),
                child: ToggleOption(
          ...
          if (!kIsWeb && Platform.isAndroid)
            SliverToBoxAdapter(
              child: SmoothHighlight(
                key: settingToHighlight == LocalSettings.enableInboxNotifications ? settingToHighlightKey : null,
                useInitialHighLight: settingToHighlight == LocalSettings.enableInboxNotifications,
                enabled: settingToHighlight == LocalSettings.enableInboxNotifications,
                color: theme.colorScheme.primaryContainer,
                child: Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 16.0),
                  child: ToggleOption(
          ...
          SliverToBoxAdapter(
            child: SmoothHighlight(
              key: settingToHighlight == LocalSettings.importExportSettings ? settingToHighlightKey : null,
              useInitialHighLight: settingToHighlight == LocalSettings.importExportSettings,
              enabled: settingToHighlight == LocalSettings.importExportSettings,
              color: theme.colorScheme.primaryContainer,
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16.0),
                child: SettingsListTile(
