  ...
  void setPreferences(attribute, value) async {
    ...
    switch (attribute) {
      ...
      case 'setting_general_mark_post_read_on_media_view':
        await prefs.setBool(
            'setting_general_mark_post_read_on_media_view', value);
      ...
      case 'setting_comments_collapse_parent_comment_on_gesture':
        await prefs.setBool(
            'setting_comments_collapse_parent_comment_on_gesture', value);
        setState(() => collapseParentCommentOnGesture = value);
        break;
      case 'setting_general_show_comment_button_actions':
        await prefs.setBool(
            'setting_general_show_comment_button_actions', value);
      ...
      case 'setting_general_nested_comment_indicator_style':
        await prefs.setString(
            'setting_general_nested_comment_indicator_style', value);
      ...
      case 'setting_general_nested_comment_indicator_color':
        await prefs.setString(
            'setting_general_nested_comment_indicator_color', value);
  ...
  void _initPreferences() async {
    ...
    setState(() {
      ...
      nestedIndicatorStyle = NestedCommentIndicatorStyle.values.byName(
          prefs.getString("setting_general_nested_comment_indicator_style") ??
              DEFAULT_NESTED_COMMENT_INDICATOR_STYLE.name);
      nestedIndicatorColor = NestedCommentIndicatorColor.values.byName(
          prefs.getString("setting_general_nested_comment_indicator_color") ??
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ToggleOption(
                          ...
                          onToggle: (bool value) =>
                              setPreferences('setting_post_tablet_mode', value),
                        ),
                        ToggleOption(
                          ...
                          onToggle: (bool value) => setPreferences(
                              'setting_general_hide_nsfw_previews', value),
                        ),
                        ToggleOption(
                          ...
                          onToggle: (bool value) => setPreferences(
                              "setting_general_mark_post_read_on_media_view",
                              value),
                        ),
                        ToggleOption(
                          ...
                          onToggle: (bool value) => setPreferences(
                              'setting_use_display_names_for_users', value),
                        ),
                        ToggleOption(
                          ...
                          onToggle: (bool value) =>
                              setPreferences('setting_disable_feed_fab', value),
                        ),
                        ListOption(
                          ...
                          onChanged: (value) => setPreferences(
                              'setting_general_default_listing_type',
                              value.payload.name),
                        ),
                        ListOption(
                          ...
                          customListPicker: SortPicker(
                            ...
                            onSelect: (value) {
                              setPreferences(
                                  'setting_general_default_sort_type',
                                  value.payload.name);
                            },
                          ),
                        ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ToggleOption(
                          ...
                          iconDisabled: Icons.visibility,
                          onToggle: (bool value) => setPreferences(
                              'setting_disable_post_fabs', value),
                        ),
                        ToggleOption(
                          ...
                          onToggle: (bool value) => setPreferences(
                              'setting_general_use_compact_view', value),
                        ),
                        AnimatedSwitcher(
                                  ...
                                  child: Column(
                                    children: [
                                      ToggleOption(
                                        ...
                                        onToggle: (bool value) => setPreferences(
                                            'setting_compact_show_thumbnail_on_right',
                                            value),
                                      ),
                                      ToggleOption(
                                        ...
                                        onToggle: (bool value) => setPreferences(
                                            'setting_compact_show_text_post_indicator',
                                            value),
                                      ),
                                    ],
                                  ),
                                  ...
                                  child: Column(
                                    children: [
                                      ToggleOption(
                                        ...
                                        onToggle: (bool value) => setPreferences(
                                            'setting_general_show_title_first',
                                            value),
                                      ),
                                      ToggleOption(
                                        ...
                                        onToggle: (bool value) => setPreferences(
                                            'setting_general_show_full_height_images',
                                            value),
                                      ),
                                      ToggleOption(
                                        ...
                                        onToggle: (bool value) => setPreferences(
                                            'setting_general_show_edge_to_edge_images',
                                            value),
                                      ),
                                      ToggleOption(
                                        ...
                                        onToggle: (bool value) => setPreferences(
                                            'setting_general_show_text_content',
                                            value),
                                      ),
                                      ToggleOption(
                                        ...
                                        iconDisabled:
                                            Icons.import_export_rounded,
                                        onToggle: (bool value) => setPreferences(
                                            'setting_general_show_vote_actions',
                                            value),
                                      ),
                                      ToggleOption(
                                        ...
                                        onToggle: (bool value) => setPreferences(
                                            'setting_general_show_save_action',
                                            value),
                                      ),
                                    ],
                                  ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ToggleOption(
                          ...
                          onToggle: (bool value) => setPreferences(
                              'setting_comments_collapse_parent_comment_on_gesture',
                              value),
                        ),
                        ToggleOption(
                          ...
                          onToggle: (bool value) => setPreferences(
                              'setting_general_show_comment_button_actions',
                              value),
                        ),
                        ListOption(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ToggleOption(
                          ...
                          onToggle: (bool value) => setPreferences(
                              'setting_general_show_link_previews', value),
                        ),
                        ToggleOption(
                          ...
                          onToggle: (bool value) => setPreferences(
                              'setting_links_open_in_external_browser', value),
                        ),
                      ],
                    ),
                  ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ToggleOption(
                          ...
                          onToggle: (bool value) => setPreferences(
                              'setting_notifications_show_inapp_update', value),
                        ),
                      ],
                    ),
                  ),
