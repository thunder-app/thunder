...
enum LocalSettingsCategories {
  ...
  factory LocalSettingsCategories.fromJson(String value) =>
...
enum LocalSettingsSubCategories {
  ...
  factory LocalSettingsSubCategories.fromJson(String value) =>
      values.firstWhere((e) => e.value == value);
...
enum LocalSettings {
  ...
  discussionLanguages(
      name: 'account_discussion_languages',
      key: 'discussionLanguages',
  ...
  defaultFeedSortType(
      name: 'setting_general_default_sort_type',
      key: 'defaultFeedSortType',
      category: LocalSettingsCategories.general,
      subCategory: LocalSettingsSubCategories.feedTypeAndSorts),

  // NSFW Settings
  hideNsfwPosts(
      name: 'setting_general_hide_nsfw_posts',
      key: 'hideNsfwPostsFromFeed',
      category: LocalSettingsCategories.general,
      subCategory: LocalSettingsSubCategories.feed),
  hideNsfwPreviews(
      name: 'setting_general_hide_nsfw_previews',
      key: 'hideNsfwPreviews',
      category: LocalSettingsCategories.posts,
      subCategory: LocalSettingsSubCategories.general),

  // Tablet Settings
  useTabletMode(
      name: 'setting_post_tablet_mode',
      key: 'tabletMode',
      category: LocalSettingsCategories.general,
      subCategory: LocalSettingsSubCategories.feed),
  ...
  scrapeMissingPreviews(
      name: 'setting_general_scrape_missing_previews',
      key: 'scrapeMissingLinkPreviews',
      category: LocalSettingsCategories.general,
  ...
  openLinksInExternalBrowser(
      ...
      searchable: false),
  browserMode(
      name: 'setting_browser_mode',
      key: 'browserMode',
      category: LocalSettingsCategories.general,
      subCategory: LocalSettingsSubCategories.linksBehaviourSettings),
  openByDefault(
      name: 'setting_links_open_by_default',
      key: 'openByDefault',
      category: LocalSettingsCategories.general,
      subCategory: LocalSettingsSubCategories.linksBehaviourSettings),
  ...
  useDisplayNamesForUsers(
      name: 'setting_use_display_names_for_users',
      key: 'showUserDisplayNames',
  ...
  markPostAsReadOnScroll(
      name: 'setting_general_mark_post_read_on_scroll',
      key: 'markPostAsReadOnScroll',
      category: LocalSettingsCategories.general,
      subCategory: LocalSettingsSubCategories.feed),
  ...
  showUpdateChangelogs(
      name: 'setting_show_update_changelogs',
      key: 'showUpdateChangelogs',
      category: LocalSettingsCategories.general,
      subCategory: LocalSettingsSubCategories.notifications),
  scoreCounters(
      name: 'setting_score_counters',
      key: "showScoreCounters",
      category: LocalSettingsCategories.general,
      subCategory: LocalSettingsSubCategories.feed),
  appLanguageCode(
      name: 'setting_app_language_code',
      key: 'appLanguage',
      category: LocalSettingsCategories.general,
      subCategory: LocalSettingsSubCategories.feedTypeAndSorts),
  ...
  inboxNotificationType(
      name: 'setting_inbox_notification_type',
      key: 'inboxNotificationType',
      category: LocalSettingsCategories.general,
      subCategory: LocalSettingsSubCategories.notifications),
  pushNotificationServer(
      name: 'setting_push_notification_server',
      key: 'pushNotificationServer',
      category: LocalSettingsCategories.general,
      subCategory: LocalSettingsSubCategories.notifications),
  ...
  useCompactView(
      name: 'setting_general_use_compact_view',
      key: 'compactView',
      category: LocalSettingsCategories.posts,
      subCategory: LocalSettingsSubCategories.posts),
  showPostTitleFirst(
      name: 'setting_general_show_title_first',
      key: 'showPostTitleFirst',
      category: LocalSettingsCategories.posts,
      subCategory: LocalSettingsSubCategories.posts),
  hideThumbnails(
      name: 'setting_general_hide_thumbnails',
      key: 'hideThumbnails',
      category: LocalSettingsCategories.posts,
      subCategory: LocalSettingsSubCategories.feed),
  ...
  showTextPostIndicator(
      name: 'setting_compact_show_text_post_indicator',
      key: 'showTextPostIndicator',
      category: LocalSettingsCategories.posts,
      subCategory: LocalSettingsSubCategories.posts),
  tappableAuthorCommunity(
      name: 'setting_compact_tappable_author_community',
      key: 'tappableAuthorCommunity',
      category: LocalSettingsCategories.general,
      subCategory: LocalSettingsSubCategories.feed),

  // General Settings
  showPostVoteActions(
      name: 'setting_general_show_vote_actions',
      key: 'showPostVoteActions',
      category: LocalSettingsCategories.posts,
      subCategory: LocalSettingsSubCategories.cardView),
  showPostSaveAction(
      name: 'setting_general_show_save_action',
      key: 'showPostSaveAction',
      category: LocalSettingsCategories.posts,
      subCategory: LocalSettingsSubCategories.cardView),
  showPostCommunityIcons(
      name: 'setting_general_show_community_icons',
      key: 'showPostCommunityIcons',
      category: LocalSettingsCategories.posts,
      subCategory: LocalSettingsSubCategories.cardView),
  showPostFullHeightImages(
      name: 'setting_general_show_full_height_images',
      key: 'showFullHeightImages',
      category: LocalSettingsCategories.posts,
      subCategory: LocalSettingsSubCategories.cardView),
  showPostEdgeToEdgeImages(
      name: 'setting_general_show_edge_to_edge_images',
      key: 'showEdgeToEdgeImages',
      category: LocalSettingsCategories.posts,
      subCategory: LocalSettingsSubCategories.cardView),
  showPostTextContentPreview(
      name: 'setting_general_show_text_content',
      key: 'showPostTextContentPreview',
      category: LocalSettingsCategories.posts,
      subCategory: LocalSettingsSubCategories.cardView),
  showPostAuthor(
      name: 'setting_general_show_post_author',
      key: 'showPostAuthor',
      category: LocalSettingsCategories.posts,
      subCategory: LocalSettingsSubCategories.general),
  postShowUserInstance(
      name: 'setting_general_post_show_user_instance',
      key: 'postShowUserInstance',
      category: LocalSettingsCategories.posts,
      subCategory: LocalSettingsSubCategories.general),
  dimReadPosts(
      name: 'setting_dim_read_posts',
      key: 'dimReadPosts',
      category: LocalSettingsCategories.posts,
      subCategory: LocalSettingsSubCategories.general),
  keywordFilters(
      name: 'setting_general_keyword_filters',
      key: 'keywordFilters',
      category: LocalSettingsCategories.filters,
      subCategory: LocalSettingsSubCategories.filters),
  hideTopBarOnScroll(
      name: 'setting_general_hide_topbar_on_scroll',
      key: 'hideTopBarOnScroll',
      category: LocalSettingsCategories.general,
      subCategory: LocalSettingsSubCategories.feed),
  showHiddenPosts(
      name: 'setting_general_show_hidden_posts',
      key: 'showHiddenPosts',
      category: LocalSettingsCategories.general,
      subCategory: LocalSettingsSubCategories.feed),
  ...
  cardPostCardMetadataItems(
      ...
      key: 'cardPostCardMetadataItems',
      category: LocalSettingsCategories.posts,
      subCategory: LocalSettingsSubCategories.posts),
  showFullPostDate(
      name: 'setting_general_show_full_post_date',
      key: 'showFullPostDate',
      category: LocalSettingsCategories.posts,
      subCategory: LocalSettingsSubCategories.posts),
  dateFormat(
      name: 'setting_general_date_format',
      key: 'dateFormat',
      category: LocalSettingsCategories.posts,
      subCategory: LocalSettingsSubCategories.posts),
  ...
  feedCardDividerColor(
      name: 'setting_feed_card_divider_color',
      key: 'feedCardDividerColor',
      category: LocalSettingsCategories.posts,
      subCategory: LocalSettingsSubCategories.posts,
      searchable: false),
  ...
  // Post body settings
  showCrossPosts(
      name: 'setting_show_cross_posts',
      key: 'showCrossPosts',
      category: LocalSettingsCategories.posts,
      subCategory: LocalSettingsSubCategories.general),
  postBodyViewType(
      name: 'setting_general_post_body_view_type',
      key: 'postBodyViewType',
      category: LocalSettingsCategories.posts,
      subCategory: LocalSettingsSubCategories.general),
  ...
  // Advanced Settings
  imageCachingMode(
      name: 'setting_advanced_image_caching_mode',
      key: 'imageCachingMode',
      category: LocalSettingsCategories.general,
      subCategory: LocalSettingsSubCategories.advanced),
  showNavigationLabels(
      name: 'setting_advanced_show_navigation_labels',
      key: 'showNavigationLabels',
      category: LocalSettingsCategories.general,
      subCategory: LocalSettingsSubCategories.advanced),
  ...
  commentShowUserInstance(
      name: 'settings_comment_show_user_instance',
      key: 'showUserInstance',
      category: LocalSettingsCategories.comments,
      subCategory: LocalSettingsSubCategories.comments),
  commentShowUserAvatar(
      name: 'settings_comment_show_user_avatar',
      key: 'showUserAvatar',
      category: LocalSettingsCategories.comments,
      subCategory: LocalSettingsSubCategories.comments),
  combineCommentScores(
      name: 'setting_general_combine_comment_scores',
      key: 'combineCommentScores',
      category: LocalSettingsCategories.comments,
      subCategory: LocalSettingsSubCategories.comments),
  ...
  reduceAnimations(
      name: 'setting_accessibility_reduce_animations',
      key: 'reduceAnimations',
      category: LocalSettingsCategories.accessibility,
      subCategory: LocalSettingsSubCategories.animations),

  /// -------------------------- Theme Related Settings --------------------------
  // Theme Settings
  appTheme(
      name: 'setting_theme_app_theme',
      key: 'theme',
      category: LocalSettingsCategories.theming,
      subCategory: LocalSettingsSubCategories.theme),
  appThemeAccentColor(
      name: 'setting_theme_custom_app_theme',
      key: 'themeAccentColor',
      category: LocalSettingsCategories.theming,
      subCategory: LocalSettingsSubCategories.theme),
  useMaterialYouTheme(
      name: 'setting_theme_use_material_you',
      key: 'useMaterialYouTheme',
      category: LocalSettingsCategories.theming,
      subCategory: LocalSettingsSubCategories.theme),
  ...
  actionColors(
      name: 'setting_action_colors',
      key: 'actionColors',
      category: LocalSettingsCategories.theming,
      subCategory: LocalSettingsSubCategories.theme),
  upvoteColor(
      name: 'settings_theme_upvote_color',
      key: 'upvoteColor',
      searchable: false),
  downvoteColor(
      name: 'settings_theme_downvote_color',
      key: 'downvoteColor',
      searchable: false),
  saveColor(
      name: 'settings_theme_save_color', key: 'saveColor', searchable: false),
  markReadColor(
      name: 'settings_theme_mark_read_color',
      key: 'markReadColor',
      searchable: false),
  hideColor(
      name: 'settings_theme_hide_color', key: 'hideColor', searchable: false),
  replyColor(
      name: 'settings_theme_reply_color', key: 'replyColor', searchable: false),

  // Font Settings
  titleFontSizeScale(
      name: 'setting_theme_title_font_size_scale',
      key: 'postTitleFontScale',
      category: LocalSettingsCategories.theming,
      subCategory: LocalSettingsSubCategories.fonts),
  contentFontSizeScale(
      name: 'setting_theme_content_font_size_scale',
      key: 'postContentFontScale',
      category: LocalSettingsCategories.theming,
      subCategory: LocalSettingsSubCategories.fonts),
  commentFontSizeScale(
      name: 'setting_theme_comment_font_size_scale',
      key: 'commentFontScale',
      category: LocalSettingsCategories.theming,
      subCategory: LocalSettingsSubCategories.fonts),
  metadataFontSizeScale(
      name: 'setting_theme_metadata_font_size_scale',
  ...
  userLabels(
      name: 'setting_user_labels',
      key: 'userLabels',
      category: LocalSettingsCategories.userLabels),
  ...
  enablePostGestures(
      name: 'setting_gesture_enable_post_gestures',
      key: 'postSwipeActions',
      category: LocalSettingsCategories.gestures,
      subCategory: LocalSettingsSubCategories.posts),
  postGestureLeftPrimary(
      name: 'setting_gesture_post_left_primary_gesture',
      key: 'leftShortSwipe',
      category: LocalSettingsCategories.gestures,
      subCategory: LocalSettingsSubCategories.posts),
  postGestureLeftSecondary(
      name: 'setting_gesture_post_left_secondary_gesture',
      key: 'leftLongSwipe',
      category: LocalSettingsCategories.gestures,
      subCategory: LocalSettingsSubCategories.posts),
  postGestureRightPrimary(
      name: 'setting_gesture_post_right_primary_gesture',
      key: 'rightShortSwipe',
      category: LocalSettingsCategories.gestures,
      subCategory: LocalSettingsSubCategories.posts),
  postGestureRightSecondary(
      name: 'setting_gesture_post_right_secondary_gesture',
      key: 'rightLongSwipe',
      category: LocalSettingsCategories.gestures,
      subCategory: LocalSettingsSubCategories.posts),
  ...
  enableCommentGestures(
      name: 'setting_gesture_enable_comment_gestures',
      key: 'commentSwipeActions',
      category: LocalSettingsCategories.gestures,
      subCategory: LocalSettingsSubCategories.comments),
  commentGestureLeftPrimary(
      name: 'setting_gesture_comment_left_primary_gesture',
      key: 'leftShortSwipe',
      category: LocalSettingsCategories.gestures,
      subCategory: LocalSettingsSubCategories.comments),
  ...
  enableFeedsFab(
      name: 'setting_enable_feed_fab',
      key: 'enableFloatingButtonOnFeeds',
      category: LocalSettingsCategories.floatingActionButton,
      subCategory: LocalSettingsSubCategories.feed),
  enablePostsFab(
      name: 'setting_enable_post_fab',
      key: 'enableFloatingButtonOnPosts',
      category: LocalSettingsCategories.floatingActionButton,
      subCategory: LocalSettingsSubCategories.feed),
  enableBackToTop(
      name: 'setting_enable_back_to_top_fab',
      key: 'backToTop',
      category: LocalSettingsCategories.floatingActionButton,
      subCategory: LocalSettingsSubCategories.feed),
  enableSubscriptions(
      name: 'setting_enable_subscribed_fab',
      key: 'subscriptions',
      category: LocalSettingsCategories.floatingActionButton,
      subCategory: LocalSettingsSubCategories.feed),
  enableRefresh(
      name: 'setting_enable_refresh_fab',
      key: 'refresh',
      category: LocalSettingsCategories.floatingActionButton,
      subCategory: LocalSettingsSubCategories.feed),
  enableDismissRead(
      name: 'setting_enable_dismiss_read_fab',
      key: 'dismissRead',
      category: LocalSettingsCategories.floatingActionButton,
      subCategory: LocalSettingsSubCategories.feed),
  enableChangeSort(
      name: 'setting_enable_change_sort_fab',
      key: 'changeSort',
      category: LocalSettingsCategories.floatingActionButton,
      subCategory: LocalSettingsSubCategories.feed),
  enableNewPost(
      name: 'setting_enable_new_post_fab',
      key: 'newPost',
      category: LocalSettingsCategories.floatingActionButton,
      subCategory: LocalSettingsSubCategories.feed),
  postFabEnableBackToTop(
      name: 'setting_post_fab_enable_back_to_top',
      key: 'backToTop',
      category: LocalSettingsCategories.floatingActionButton,
      subCategory: LocalSettingsSubCategories.posts),
  postFabEnableChangeSort(
      name: 'setting_post_fab_enable_change_sort',
      key: 'changeSort',
      category: LocalSettingsCategories.floatingActionButton,
      subCategory: LocalSettingsSubCategories.posts),
  postFabEnableReplyToPost(
      name: 'setting_post_fab_enable_reply_to_post',
      key: 'replyToPost',
      category: LocalSettingsCategories.floatingActionButton,
      subCategory: LocalSettingsSubCategories.posts),
  postFabEnableRefresh(
      name: 'setting_post_fab_enable_refresh',
      key: 'refresh',
      category: LocalSettingsCategories.floatingActionButton,
      subCategory: LocalSettingsSubCategories.posts),
  postFabEnableSearch(
      name: 'setting_post_fab_enable_search',
      key: 'search',
      category: LocalSettingsCategories.floatingActionButton,
      subCategory: LocalSettingsSubCategories.posts),
  feedFabSinglePressAction(
      name: 'settings_feed_fab_single_press_action',
      key: '',
      category: LocalSettingsCategories.floatingActionButton,
      subCategory: LocalSettingsSubCategories.feed),
  feedFabLongPressAction(
      name: 'settings_feed_fab_long_press_action',
      key: '',
      category: LocalSettingsCategories.floatingActionButton,
      subCategory: LocalSettingsSubCategories.feed),
  postFabSinglePressAction(
      name: 'settings_post_fab_single_press_action',
      key: '',
      category: LocalSettingsCategories.floatingActionButton,
      subCategory: LocalSettingsSubCategories.posts),
  postFabLongPressAction(
      name: 'settings_post_fab_long_press_action',
      key: '',
      category: LocalSettingsCategories.floatingActionButton,
      subCategory: LocalSettingsSubCategories.posts),
  enableCommentNavigation(
      name: 'setting_enable_comment_navigation',
      key: 'enableCommentNavigation',
      category: LocalSettingsCategories.general,
      subCategory: LocalSettingsSubCategories.comments),
  combineNavAndFab(
      name: 'setting_combine_nav_and_fab',
      key: 'combineNavAndFab',
      category: LocalSettingsCategories.general,
      subCategory: LocalSettingsSubCategories.comments),
  ...
  imageDimensionTimeout(
      name: 'setting_image_dimension_timeout',
      key: 'imageDimensionTimeout',
      category: LocalSettingsCategories.debug),
  ...
  importExportSettings(
      ...
      key: 'importExportSettings',
      category: LocalSettingsCategories.general,
      subCategory: LocalSettingsSubCategories.importExportSettings),
  importExportDatabase(
      name: 'import_export_database',
      key: 'importExportDatabase',
      category: LocalSettingsCategories.general,
      subCategory: LocalSettingsSubCategories.importExportSettings),
  // video player
  videoAutoMute(
      name: 'auto_mute_videos',
      key: 'videoAutoMute',
      category: LocalSettingsCategories.videoPlayer,
      subCategory: LocalSettingsSubCategories.videoPlayer),
  videoDefaultPlaybackSpeed(
      name: 'video_default_playback_speed',
      key: 'videoDefaultPlaybackSpeed',
      category: LocalSettingsCategories.videoPlayer,
      subCategory: LocalSettingsSubCategories.videoPlayer),
  videoAutoFullscreen(
      name: 'video_auto_fullscreen',
      key: 'videoAutoFullscreen',
      category: LocalSettingsCategories.videoPlayer,
      subCategory: LocalSettingsSubCategories.videoPlayer),
  videoAutoLoop(
      name: 'video_auto_loop',
      key: '',
      category: LocalSettingsCategories.videoPlayer,
      subCategory: LocalSettingsSubCategories.videoPlayer),
  videoAutoPlay(
