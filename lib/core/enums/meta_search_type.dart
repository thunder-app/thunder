...
class MetaSearchType {
  ...
  static const MetaSearchType comments =
      MetaSearchType(searchType: SearchType.comments);
  static const MetaSearchType posts =
      MetaSearchType(searchType: SearchType.posts);
  static const MetaSearchType communities =
      MetaSearchType(searchType: SearchType.communities);
  static const MetaSearchType users =
      MetaSearchType(searchType: SearchType.users);
