...
class AppLocalizationsUk extends AppLocalizations {
  ...
  String account(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Обліковий запис',
      one: 'Обліковий запис',
      zero: 'Облікових записів',
    );
    return '$_temp0 ';
  }
  ...
  String get accountSettingOverrideWarning =>
      'Налаштування вашого облікового запису замінять наступні параметри';
  ...
  String get addAccountToSeeProfile =>
      'Увійдіть, щоб побачити тут ваш профіль.';
  ...
  String get allowOpenSupportedLinks =>
      'Дозволити програмі відкривати підтримувані посилання.';
  ...
  String get backgroundCheckWarning =>
      'Зауважте, що перевірка сповіщень витрачає додатковий заряд акумулятора';
  ...
  String get internetOrInstanceIssues =>
      'Можливо, немає підключення до Інтернету, або ваш сервер тимчасово недоступний.';
  ...
  String get onlyModsCanPostInCommunity =>
      'Тільки модератори можуть робити публікації в цій спільноті';
  ...
  String get timeoutErrorMessage =>
      'Сплив час очікування на відповідь від сервера.';
