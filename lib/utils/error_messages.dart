...
String getExceptionErrorMessage(Object? e, {String? additionalInfo}) {
  if (e is LemmyApiException) {
    return getErrorMessage(GlobalContext.context, e.message,
...
String? getErrorMessage(BuildContext context, String lemmyApiErrorCode,
  ...
  return switch (lemmyApiErrorCode) {
    ...
    "couldnt_find_community" => additionalInfo != null
        ? l10n.unableToFindCommunityName(additionalInfo)
        : l10n.unableToFindCommunity,
    "couldnt_find_person" => additionalInfo != null
        ? l10n.unableToFindUserName(additionalInfo)
        : l10n.unableToFindUser,
