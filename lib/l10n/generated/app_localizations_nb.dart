...
class AppLocalizationsNb extends AppLocalizations {
  ...
  String get accessibilityProfilesDescription =>
      'Tilgjengelighetsprofiler lar deg bruke flere innstillinger samtidig for å imøtekomme en spesifikk begrensning.';
  ...
  String get addAccountToSeeProfile =>
      'Legg til en konto for å vise profilen din.';
  ...
  String get clearedDatabase =>
      'Lokal database tømt. Start Thunder på ny for å ta i bruk endringer.';
  ...
  String get customizeSwipeActions =>
      'Tilpass dragningshandlinger (trykk for å endre)';
  ...
  String get internetOrInstanceIssues =>
      'Det kan hende du ikke er tilkoblet Internett, eller at instansen din er utilgjengelig.';
  ...
  String get noCommunityBlocks =>
      'Det ser ut til at du ikke har blokkert noen gemenskaper.';
  ...
  String get onlyModsCanPostInCommunity =>
      'Kun moderatorer kan sende innlegg til denne gemenskapen';
  ...
  String get removedCommunityFromSubscriptions =>
      'Fjernet abonnement på gemenskap';
  ...
  String get replyNotSupported =>
      'Besvaring fra denne visningen støttes ikke enda';
  ...
  String get screenReaderProfileDescription =>
      'Optimaliserer Thunder for skjermlesere ved å redusere totalt antall elementer og ved fjerning av håndvendinger som kan være i konflikt med hverandre.';
