...
class AppLocalizationsPs extends AppLocalizations {
  ...
  @override
  String get accessibilityProfilesDescription => 'د لاسرسي وړ پېژنيالونه تاسو ته اجازه درکوي چې په يو ځل څو اوڼنې پلې کړئ؛ ترڅو د لاسرسي ځانگړې اړتيا پوره کړي.';

  @override
  String account(num count) {
    String _temp0 = intl.Intl.pluralLogic(count, locale: localeName, other: 'گڼونونه', one: 'Account', zero: 'گڼون');
    return '$_temp0 ';
  }
  ...
  @override
  String get accountSettingOverrideWarning => 'ستاسو د گڼون اوڼنې لاندې اوڼنې له پامه غورځوي';
  ...
  @override
  String get accountSettingsImportedSuccessfully => 'لېمي گڼون اوڼنې په برياليتوب سره راولېږدول شوې!';
  ...
  @override
  String get addAccountToSeeProfile => 'د خپل گڼون ليدلو لپاره غونډال ته ننوځئ.';
  ...
  @override
  String get allowOpenSupportedLinks => 'کاريال ته د ملاتړ شوو تړونو د پرانېستلو اجازه ورکول.';
  ...
  @override
  String get backgroundCheckWarning => 'په ياد ولرئ چې د خبرتياوو سم‌کتنه به زياتي بېټرۍ هم ولگوئ';
  ...
  @override
  String get cannotReportOwnComment => 'تاسو شايد د خپلې څرگندونې لپاره راپور ونه سپارئ.';
  ...
  @override
  String get changePasswordWarning => 'پټنوم بدلولو لپاره به تاسو د بېلگې وېبځي ته مخگرځ شئ.\n\nايا ډاډه ياست چې دوام ورکړئ؟';
  ...
  @override
  String get clearedDatabase => 'ځايي اومتوک اډانه سپا شوه. د نوو بدلونونو پلې کېدو لپاره تندر له سره پيل کړئ.';
  ...
  @override
  String get collapseParentCommentBodyOnGesture => 'د غځېدلو پرمهال لويې څرگندونې پټول';
  ...
  @override
  String get combineNavAndFabDescription => 'لامبو وهلو چارې تڼۍ به د گرځښت تڼيو ترمنځ وښودل شي.';
