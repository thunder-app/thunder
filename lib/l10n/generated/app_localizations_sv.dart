...
class AppLocalizationsSv extends AppLocalizations {
  ...
  @override
  String get accessibilityProfilesDescription => 'Tillgänglighetsprofiler gör det möjligt att tillämpa flera inställningar samtidigt för att tillgodose ett specifikt tillgänglighetskrav.';

  @override
  String account(num count) {
    String _temp0 = intl.Intl.pluralLogic(count, locale: localeName, other: 'Konton', one: 'Konto', zero: 'Konto');
    return '$_temp0 ';
  }
  ...
  @override
  String get accountSettingOverrideWarning => 'Dina kontoinställningar åsidosätter följande inställningar';
  ...
  @override
  String get accountSettingsImportedSuccessfully => 'Lemmy-kontoinställningar har importerats!';
