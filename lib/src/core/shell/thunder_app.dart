...
import 'package:thunder/src/core/shell/session.dart';
import 'package:thunder/src/core/shell/session_scope.dart';
...
import 'package:thunder/src/core/shell/thunder_page.dart';
...
class _ThunderAppState extends State<ThunderApp> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      final String? inboxNotificationType = const UserPreferencesStore().getLocalSetting(LocalSettings.inboxNotificationType);
      ...
      if (NotificationType.values.byName(inboxNotificationType) != NotificationType.none) {
        ...
        if (success) {
          const UserPreferencesStore().removeSetting(LocalSettings.inboxNotificationType);
        }
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (context) => createAppVersionCubit()),
        BlocProvider(create: (context) => createThunderCubit()..reload()),
