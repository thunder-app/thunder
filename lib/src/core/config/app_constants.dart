...
/// Instance and sorting types
const String DEFAULT_INSTANCE = 'lemmy.world';
...
/// Intents
const int ANDROID_INTENT_FLAG_ACTIVITY_NEW_TASK = 268435456; // https://developer.android.com/reference/android/content/Intent#FLAG_ACTIVITY_NEW_TASK
