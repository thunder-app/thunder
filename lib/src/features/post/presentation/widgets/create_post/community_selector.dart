...
class CommunitySelector extends StatelessWidget {
  const CommunitySelector({super.key, required this.account, this.community, required this.onCommunitySelected});
  ...
  Widget build(BuildContext context) {
    ...
    return Transform.translate(
      ...
      child: InkWell(
        onTap: () {
          showCommunityInputDialog(context, title: l10n.community, account: account, onCommunitySelected: onCommunitySelected);
        },
                  ...
                  community != null
                      ? Column(
                          ...
                          children: [
                            ...
                            CommunityFullNameWidget(name: community!.name, displayName: community!.title, instance: fetchInstanceNameFromUrl(community!.actorId), useDisplayName: false),
                          ],
                        )
                      : SizedBox(
                          height: 39.0,
