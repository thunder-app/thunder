                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(l10n.animations, style: theme.textTheme.titleLarge),
                    ),
                    ThunderToggleOption(
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(l10n.profiles, style: theme.textTheme.titleLarge),
                    ),
                    Padding(
                      padding: const EdgeInsets.all(6.0),
                      child: Text(l10n.accessibilityProfilesDescription, style: TextStyle(color: theme.colorScheme.onSurface.withValues(alpha: 0.75))),
                    ),
