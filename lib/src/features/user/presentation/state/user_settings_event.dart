...
class UpdateUserSettingsEvent extends UserSettingsEvent {
  ...
  @override
  List<Object?> get props => [displayName, bio, email, matrixUserId, defaultFeedListType, defaultPostSortType, showNsfw, showReadPosts, showScores, botAccount, showBotAccounts, discussionLanguages];
}
...
class UnblockInstanceEvent extends UserSettingsEvent {
  ...
  @override
  List<Object?> get props => [instanceId, unblock];
}
...
class UnblockCommunityEvent extends UserSettingsEvent {
  ...
  @override
  List<Object?> get props => [communityId, unblock];
}
...
class UnblockPersonEvent extends UserSettingsEvent {
  ...
  @override
  List<Object?> get props => [personId, unblock];
}
...
class DeleteMediaEvent extends UserSettingsEvent {
  ...
  @override
  List<Object?> get props => [deleteToken, id];
}
