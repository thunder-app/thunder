...
class AddProfile extends ProfileEvent {
  ...
  @override
  List<Object> get props => [reload, username, password, instance, totp, showContentWarning];
}
...
class RemoveProfile extends ProfileEvent {
  ...
  @override
  List<Object> get props => [reload, accountId];
}
...
class SwitchProfile extends ProfileEvent {
  ...
  const SwitchProfile({required this.accountId, super.reload = true});
