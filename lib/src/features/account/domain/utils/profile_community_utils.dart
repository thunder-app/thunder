...
bool isSameUser({required ThunderUser user, required Account account}) {
  return user.id == account.userId;
}

List<ThunderCommunity> filterFavorites({required List<ThunderCommunity> subscriptions, required List<Favorite> favorites}) {
