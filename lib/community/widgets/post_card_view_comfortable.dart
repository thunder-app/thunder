...
class PostCardViewComfortable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Color? communityAndAuthorColorTransformation(Color? color) =>
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
              ...
              child: Text.rich(
                TextSpan(
                  children: [
                    ...
                    TextSpan(
                      text: HtmlUnescape()
                          .convert(postViewMedia.postView.post.name),
          ...
          if (postViewMedia.media.first.mediaType != MediaType.text &&
              edgeToEdgeImages)
            Padding(
          ...
          Visibility(
            ...
            child: Padding(
              ...
              child: ScalableText(
                parse(markdownToHtml(textContent))
                        .documentElement
                        ?.text
                        .trim() ??
                    textContent,
                  ...
                  child: Column(
                    ...
                    children: [
                      PostCommunityAndAuthor(
                        ...
                        authorColorTransformation:
                            communityAndAuthorColorTransformation,
                        communityColorTransformation:
                            communityAndAuthorColorTransformation,
                        compactMode: false,
                      ...
                      PostCardMetadata(
                        ...
                        unreadCommentCount:
                            postViewMedia.postView.unreadComments,
