...
class InitializeAuth extends UserSessionEvent {}
...
class AddProfile extends UserSessionEvent {
...
class RemoveProfile extends UserSessionEvent {
...
///
/// TODO: Consolidate logic so that anonymous accounts are also handled here.
class SwitchProfile extends UserSessionEvent {
  final String accountId;
  @override
  final bool reload;
...
class FetchProfileSettings extends UserSessionEvent {}

class ResetAccountState extends UserSessionEvent {
  const ResetAccountState();
}

class FetchProfileInformation extends UserSessionEvent {
...
class FetchProfileSubscriptions extends UserSessionEvent {
...
class FetchProfileFavorites extends UserSessionEvent {
